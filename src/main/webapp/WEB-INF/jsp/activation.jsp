...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"Registration Successful!
    ...
    <main role="main" id="act-main-sec">
        <section class="jumbotron text-center" id="act-content-sec">
            <div class="container">
                ...
                <h3 class="jumbotron-heading">Registration Successful!</h3>
                <p class="lead">You are now ready to use the app.</p>
                <p>
                    <a
                        href="<spring:eval expression="@environment.getProperty('portal.url')" />"
                        class="btn btn-danger my-2">Login</a>
                </p>
            </div>
            </div>
        </section>
